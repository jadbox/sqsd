...
if [ -n "$SQSD_WORKER_PORT_80_TCP_ADDR" ]; 
	then export SQSD_WORKER_HTTP_URL=http://${SQSD_WORKER_PORT_80_TCP_ADDR}:8800/sqs; 
fi

if [ -n "$SQSD_WORKER_PORT_8800_TCP_ADDR" ]; 
	then export SQSD_WORKER_HTTP_URL=http://${SQSD_WORKER_PORT_8800_TCP_ADDR}:8800/sqs; 
fi
